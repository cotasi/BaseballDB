...
<div class="container-fluid">
  <div class="row">
        ...
        <div class="dropdown-center">
    		...
    		Select Your Year
  			...
  			<ul class="dropdown-menu">
   				<li><a class="dropdown-item active" href="./PitcherMain.jsp">2022</a></li>
   ...
   <div class="chart-container">
	<canvas id="line-chart7" height="150px"></canvas>
	<script src="script_part/chartmain_07.js"></script>
   </div>
   
   
   <div class="chart-container">
	<canvas id="line-chart8" height="150px"></canvas>
	<script src="script_part/chartmain_08.js"></script>
   </div>
