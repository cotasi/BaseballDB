chartmain_08.js <%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
<!DOCTYPE html>
<html>
<head>
  ...
  <div class="row">
    <main class="col-md-12 ms-sm-auto col-lg-12 px-md-4 float-right">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Pitcher Saber Stats Samples</h1>
        <div class="dropdown-center">
  			<button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    		Select Your Year
  			</button>
  			<ul class="dropdown-menu">
   				<li><a class="dropdown-item" href="./PitcherMain.jsp">2022</a></li>
    			<li><a class="dropdown-item" href="./Pitcher2021.jsp">2021</a></li>
    			<li><a class="dropdown-item active" href="./Pitcher2020.jsp">2020</a></li>
  		   </ul>
			</div>
      </div>
   <div class="chart-container">
	<canvas id="line-chart11" height="150px"></canvas>
	<script src="script_part/chartmain_11.js"></script>
   </div>
   
   
   <div class="chart-container">
	<canvas id="line-chart12" height="150px"></canvas>
	<script src="script_part/chartmain_12.js"></script>
   </div>
