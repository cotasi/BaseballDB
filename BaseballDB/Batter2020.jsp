        ...
        <div class="dropdown-center">
    		...
    		Select Your Year
  			...
  			<ul class="dropdown-menu">
    			...
    			<li><a class="dropdown-item" href="./Batter2021.jsp">2021</a></li>
    			<li><a class="dropdown-item active" href="./Batter2020.jsp">2020</a></li>
  		   </ul>
			</div>
      </div>
   <div class="chart-container">
	<canvas id="line-chart5" height="150px"></canvas>
	<script src="script_part/chartmain_05.js"></script>
   </div>
   
   
   <div class="chart-container">
	<canvas id="line-chart6" height="150px"></canvas>
	<script src="script_part/chartmain_06.js"></script>
   </div>
