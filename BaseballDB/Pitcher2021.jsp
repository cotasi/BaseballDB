        ...
        <div class="dropdown-center">
    		...
    		Select Your Year
  			...
  			<ul class="dropdown-menu">
    			...
    			<li><a class="dropdown-item active" href="./Pitcher2021.jsp">2021</a></li>
    			<li><a class="dropdown-item" href="./Pitcher2020.jsp">2020</a></li>
  		   </ul>
			</div>
      </div>
   <div class="chart-container">
	<canvas id="line-chart9" height="150px"></canvas>
	<script src="script_part/chartmain_09.js"></script>
   </div>
   
   
   <div class="chart-container">
	<canvas id="line-chart10" height="150px"></canvas>
	<script src="script_part/chartmain_10.js"></script>
   </div>
