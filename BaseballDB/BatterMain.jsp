...
<div class="container-fluid">
  <div class="row">
        ...
        <div class="dropdown-center">
    		...
    		Select Your Year
  			...
  			<ul class="dropdown-menu">
   				<li><a class="dropdown-item active" href="./BatterMain.jsp">2022</a></li>
   ...
   <div class="chart-container">
	<canvas id="line-chart" height="150px"></canvas>
	<script src="script_part/chartmain.js"></script>
   </div>
   
   
   <div class="chart-container">
	<canvas id="line-chart2" height="150px"></canvas>
	<script src="script_part/chartmain_02.js"></script>
   </div>
